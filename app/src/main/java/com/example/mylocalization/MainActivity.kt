...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pokeCount = 3
        val hello = resources.getString(R.string.hello_world, "Miftahul Ulum", pokeCount, "Reny Setiawati")

        binding.tvHello.text = hello

        val songCount = 5
        val pluralText = resources.getQuantityString(R.plurals.numberOfSongAvailable, songCount, songCount)
